...
{
  return _coefficients[0]+_coefficients[1]*_temperature[_qp]+_coefficients[2]*_pressure[_qp]+_coefficients[3]*std::pow(_temperature[_qp],2)+_coefficients[4]*std::pow(_pressure[_qp],2);
}
